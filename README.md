...
- Avoided embedding PowerShell launch scripts, Steam install/update commands, web-download commands, archive extraction, or external installer URLs in the import JSON.
