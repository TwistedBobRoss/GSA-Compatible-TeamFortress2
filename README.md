...
The image installs/updates Steam app `232250` with SteamCMD inside the container, then launches `srcds.exe` with GSA-managed ports, slots, map, and configuration files.
...
- Added a GHCR publishing workflow for `ghcr.io/twistedbobross/gsa-compatible-teamfortress2:232250-ltsc2022-r1`.
...
1. Let the GitHub Actions workflow build and publish the GHCR image.
